...
$selected = $db->query("SELECT * FROM subject WHERE id = $edit_id");
}
?>
...
<form id="edit_form">
        ...
        <h3><?php echo $fetched['subject'];?></h3>

        <input type="hidden" name="edit_id" value="<?php echo $fetched['id'];?>">
